...
private static final int NUM_SALAS = 3;
    ...
    private String[][][] reservas; // Matriz para almacenar las reservas de las salas de cine
    private Empleado[] empleados;

    public Cine(Empleado[] empleados) {
        reservas = new String[NUM_SALAS][NUM_ASIENTOS_POR_SALA][2]; // [Sala][Asiento][ID de Empleado]
